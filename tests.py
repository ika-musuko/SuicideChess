...
class RoomTestCase(unittest.TestCase):
    ...
    def test_join_friend_game(self):
        ...
        friend_room_id, room = self.room_manager.join_friend_game(user_id=self.player2, room_id=room_id,
                                                                  access_code=room["accessCode"])
    ...
    def test_join_friend_game_in_progress(self):
        ...
        with self.assertRaises(room_exceptions.RoomIsNotWaiting):
            ...
            id, room = self.room_manager.join_friend_game(user_id=self.player2, room_id=id,
                                                          access_code=room["accessCode"])
